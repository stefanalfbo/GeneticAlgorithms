...
// generations - see Options.create's own remarks for why that matters for a fixed
// generation count with no early-exit fitness target (the optimal schedule isn't known
// ahead of time).
let options =
